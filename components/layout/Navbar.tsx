        ...
        <div className="flex items-center gap-7.5">
            <button type="button" className="relative">
                ...
                <Image
                    ...
                    width={10}
                    height={7}
                    className="absolute left-1.25 top-2.5"
                />
            </button>
            <button type="button">
                <Image
    ...
    return (
        <div className="fixed inset-0 z-50 flex justify-end">
            <button
                ...
                onClick={onClose}
            />
            <div className="relative h-full w-70.75 bg-white shadow-[-8px_0_20px_rgba(0,0,0,0.12)]">
                <div className="flex items-center justify-between p-5">
                    <p className="font-[Arial,sans-serif] text-[1rem] font-bold text-black">
                        Profile Details
                    </p>
                    <button
                        type="button"
...
export default function Navbar() {
    ...
    return (
        <>
            <nav className="flex h-13.25 items-center justify-between py-3.25">
                <div className="flex items-center gap-4.75">
                    ...
                    <div className="flex items-center gap-5.25">
                        <Image
                            ...
                            height={37}
                        />
                        <div className="h-11.25 w-0 border-l border-white/40" />
                        <span className="font-['Roboto_Slab',serif] text-[2.5rem] leading-normal text-white">
                            BuzzPort
                        </span>
                    </div>
                </div>
        ...
        <>
            <nav className="flex h-fit items-center justify-between bg-gt-gold px-4.25 py-4">
                <div className="flex items-center gap-6.75">
                    ...
                    <Link href="/">
                        <span className="font-[Arial,sans-serif] text-[1rem] leading-normal text-white">
                            Home
                        </span>
                    </Link>
                </div>
