...
const routes = [
  { name: "Blue Route", status: "On Time", nextArrival: "3:12 PM", stop: "Student Center" },
  { name: "Red Route", status: "Delayed 5 min", nextArrival: "3:25 PM", stop: "Library" },
  { name: "Green Route", status: "On Time", nextArrival: "3:40 PM", stop: "Rec Center" },
];
...
export default function TransitServiceCard() {
  return (
    ...
    >
      <div className="flex flex-col gap-2.5 px-3.5 pt-1">
        {routes.map((route) => (
          <div
            key={route.name}
