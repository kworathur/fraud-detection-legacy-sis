...
function InfoBody() {
    return (
        <div className="flex flex-1 shrink-0 flex-col gap-2.5 px-3.5">
            ...
            <ul className="list-disc font-[Arial,sans-serif] text-[0.8125rem] leading-4 text-body-text">
                <li className="mb-0 ms-[1.21875rem]">
                    Your next scholarship payment is $<strong>2,500</strong> and
                    will be deposited automatically on Feb 15th.
                </li>
                <li className="mb-0 ms-[1.21875rem]">
                    Ensure that your direct deposit information is correct prior
                    to the date above.
                </li>
                <li className="ms-[1.21875rem]">
